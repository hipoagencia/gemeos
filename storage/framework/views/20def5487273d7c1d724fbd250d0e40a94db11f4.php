...
<?php echo $__env->renderComponent(); ?>
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('admin.lead-source.update', ['lead_source' => $lead_source->id])); ?>" method="POST"
                          autocomplete="false"
                          enctype="multipart/form-data">

                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PUT'); ?>
                        <input type="hidden" name="id" value="<?php echo e($lead_source->id); ?>">
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input name="name" class="form-control"
                                                   value="<?php echo e(old('name') ?? $lead_source->name); ?>">
                                        </div>
                                    </div>
...
<?php echo $__env->make('admin.master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rivierafull\resources\views/admin/leadSource/edit.blade.php ENDPATH**/ ?>