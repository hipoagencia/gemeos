...
<?php echo $__env->renderComponent(); ?>
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('admin.groups.update', ['group' => $group->id])); ?>" method="POST"
                          autocomplete="false"
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="shareInitial">
                                                ...
                                                <?php for($x = 1; $x <= 20; $x++): ?>
                                                    <option
                                                        value="<?php echo e($x); ?>" <?php echo e(( old('shareInitial') == $x ? 'selected' : ($group->shareInitial == $x ? 'selected' : '' ))); ?>>
                                                        <?php echo e($x); ?>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="shareFinal">
                                                ...
                                                <?php for($x = 1; $x <= 20; $x++): ?>
                                                    <option
                                                        value="<?php echo e($x); ?>" <?php echo e(( old('shareFinal') == $x ? 'selected' : ($group->shareFinal == $x ? 'selected' : '' ))); ?>>
                                                        <?php echo e($x); ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea id="elm1" class="my-editor"
                                                  name="description"><?php echo e(old('description') ?? $group->description); ?></textarea>
                                    </div>
...
<?php echo $__env->make('admin.master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rivierafull\resources\views/admin/groups/edit.blade.php ENDPATH**/ ?>