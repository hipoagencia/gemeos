...
@section('content')
    ...
    <section class="parallax p-0 home-digital-agency" data-parallax-background-ratio="0.5" style="background-image: url({{$property->cover[0]->url}}); background-position: 50% 0px;">
            ...
            <div class="row">
                <div class="col-12 position-relative full-screen md-h-600px sm-h-350px d-flex flex-column">
                    ...
                    <div class="d-flex flex-row align-items-center mt-auto margin-7-half-rem-bottom">
                        <span class="bg-full-brown w-50 h-1px margin-9-rem-right sm-w-40 sm-margin-5-rem-right xs-w-15 xs-margin-2-rem-right"></span>
                ...
                <div class="col-12 col-lg-11">
                    <div class="row">
                        ...
                        <div class="col-lg-5 offset-lg-1 wow animate__fadeIn" data-wow-delay="0.4s"
                            ...
                            <script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-61c22260ce5c7010"></script>
    ...
    <section class="py-0 position-relative">
        <div class="slider-blog-banner swiper-container black-move swiper-container-initialized swiper-container-horizontal swiper-container-pointer-events"
...
{{--    </section>--}}
    ...
    <section id="call" class="cover-background wow animate__fadeIn md-background-position-right xs-no-padding-tb xs-border-tb border-color-medium-gray" style="background-image: url('{{ url(asset('web/assets/images/detal.jpg')) }}'); visibility: visible; animation-name: fadeIn;">
        <div class="container xs-no-padding-lr">
            <div class="row justify-content-center">
                <div class="col-12 col-xl-7 col-lg-8 col-md-10 wow animate__fadeIn" data-wow-delay="0.3s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeIn;">
                    <div class="text-center bg-white box-shadow-large border-radius-6px padding-5-rem-tb padding-7-rem-lr sm-padding-5-rem-all xs-padding-3-half-rem-lr xs-padding-6-rem-tb xs-no-border-radius">
                        <span class="alt-font text-medium color-full-brown text-uppercase font-weight-500 d-block margin-15px-bottom sm-margin-10px-bottom">Nós vamos te ajudar a encontrar o seu imóvel</span>
                        <h5 class="alt-font text-dark-charcoal font-weight-700 text-uppercase letter-spacing-minus-1px margin-40px-bottom w-80 mx-auto xs-w-100">Preencha os campos, em breve entraremos em contato</h5>
                        <!-- start contact form -->
                        <form  class="margin-30px-bottom">
                            <input class="medium-input border-radius-5px margin-25px-bottom required" type="text" name="name" placeholder="Nome">
                            <input class="medium-input border-radius-5px margin-25px-bottom required" type="email" name="email" placeholder="E-mail">
                            <input class="medium-input border-radius-5px margin-25px-bottom required" type="email" name="email" placeholder="Celular / WhatsApp">

                            <button class="btn btn-fancy btn-large bg-full-green text-white w-100 no-margin-bottom submit" type="submit" name="submit">Quero um contato imediato</button>
                            <div class="form-results border-radius-5px d-none"></div>
                        </form>
                        <p class="w-80 mx-auto text-extra-small line-height-22px m-0 xs-w-100">Fique tranquilo, não compactuamos com SPAM.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-center align-items-center margin-twelve-top">
                <div class="col-12 col-xl-4 col-lg-4 col-md-5 col-sm-6 text-center text-sm-end xs-margin-20px-bottom">
                    <span class="alt-font font-weight-500 text-extra-large text-extra-dark-gray d-block letter-spacing-minus-1-half">Vamos manter contato?</span>
                </div>
                ...
                <div class="col-12 col-xl-3 col-lg-4 col-md-5 col-sm-6 social-icon-style-02 text-center text-sm-start">
                    <ul class="small-icon">
                        <li><a class="facebook text-extra-dark-gray text-sm-start" href="https://www.facebook.com/fullimoveis" target="_blank"><i class="fab fa-facebook-f"></i></a></li>

                        <li><a class="instagram text-extra-dark-gray text-sm-start" href="https://www.instagram.com/rivierafull" target="_blank"><i class="fab fa-instagram"></i></a></li>

                        <li><a class="twitter text-extra-dark-gray text-sm-start" href="http://www.twitter.com" target="_blank"><i class="fab fa-pinterest"></i></a></li>
    ...
    <div class="container-fluid position-fixed w-100 bottom-0 left-0 text-center z-index-9">
        <div class="row">
          <a href="#call" class="text-white col-6 bg-full-brown pt-3 pb-3"><i class="fa fa-user"></i> Falar com um <b>consultor</b></a>
            <a href="https://api.whatsapp.com/send?phone=5513996903040&text=Ol%C3%A1%2C%20gostaria%20de%20mais%20informa%C3%A7%C3%B5es%20a%20respeito%20do%20im%C3%B3vel%20de%20c%C3%B3digo%20*{{$property->CodigoImovel}}*" class="text-white col-6 bg-full-green pt-3 pb-3"><i class="fab fa-whatsapp"></i> Contato via <b>WhatsApp</b></a>
        </div>
    </div>
