<div class="rental-block col-lg-4 col-md-6 col-sm-12">
    <div class="inner-box">
        <div class="image-box">
            ...
            <div class="price-box">
                <div class="price">{{$car->preco}}</div>
            </div>
        </div>
        <div class="title-box">
            <div class="more-link-box">
                <a href="#" class="theme-btn">Mais Informações</a>
            </div>
        ...
        <div class="meta-info">
            <ul class="clearfix">
                <li><a href="#"><span class="icon flaticon-calendar"></span> Ano: {{$car->anomodelo}}</a></li>
                <li><a href="#"><span class="icon flaticon-user"></span> Cor: {{$car->cor}}</a></li>
            </ul>
        </div>
    </div>
</div>
